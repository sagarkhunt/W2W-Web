<template>
	<vue-final-modal v-model="modalShow" classes="modal modal-container upload_contract" content-class="modal-content px-0 pb-0" :click-to-close="false">
		<!-- close btn -->
		...
		<div class="modal__content">
			...
			<div class="modal-header">
				<h5 class="title-lg">
					{{ t('managerAccount.updateUserName') }}
				</h5>
			</div>
			...
			<div class="modal-body">
				<div class="modal-form">
					<!-- form -->
					<form class="theme-input tab-form" @submit.prevent="submitForm()">
						<div class="form-row">
							<!-- contract name -->
