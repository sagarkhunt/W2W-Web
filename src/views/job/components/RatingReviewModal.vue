			...
			<div class="modal-body overflow-visible">
				<div class="modal-form">
					...
					<form class="theme-input tab-form">
						...
						<div>
							<p class="text-gray text-md fw-bold my-3">
								{{ t('job.leave_review') }}
							</p>
							<textarea
								rows="4"
						...
						<div>
							...
							<div class="d-flex my-md-0 my-2 gap-4">
								<span>
									<p class="ml-md-0 ml-2 title-xl-base" @click="suggetionTextValue('Neutral')">1) {{ t('seekerRating.neutral') }}</p>
								</span>
								<span>
									<p class="ml-md-0 ml-2 title-xl-base" @click="suggetionTextValue('Good')">2) {{ t('seekerRating.good') }}</p>
								</span>
								<span>
									<p class="ml-md-0 ml-2 title-xl-base" @click="suggetionTextValue('Very Good')">3) {{ t('seekerRating.very_good') }}</p>
								</span>
							</div>
						</div>
