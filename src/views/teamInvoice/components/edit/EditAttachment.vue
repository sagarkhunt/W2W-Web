	...
	<div class="model">
		...
		<div class="d-flex justify-content-between align-items-center mb-3 mt-5 ">
			...
			<div class="pph-right d-flex justify-content-end">
				<ToolTip :title="t('toolTip.AddAttachmentsRow')">
									...
									<div v-for="(row, index) in receiptItem" :key="index">
										<div class="details-content gap-2 mb-lg-4 mb-3">
											...
											<div class="work-width me-2 ml-xl-0 ml-3 w-20">
												<div class="position-relative" @dayclick="e => handleChangeAttachement(e.id, index, 'purchase_date')">
...
export default {
	...
	setup(props) {
		...
		const receiptData = computed(() => store.state.teamInvoice?.editTeamWorkDetailList?.invoice_files);
