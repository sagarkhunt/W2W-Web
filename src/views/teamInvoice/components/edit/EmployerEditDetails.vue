<template>
	<div class="employerDetails">
		<!-- title -->
		<div class="payment-pill-header d-sm-flex d-block">
			<!-- employer details -->
			<div class="pph-left mb-sm-0 mb-2">
						...
						<div class="pph-left-content">
							<div class="company-content">
								...
								<div class="company-text">
									<p class="company-titel">{{ t('fieldList.residence') }}:</p>
									<p class="company-value">
										{{ employerDetails.company && employerDetails.company && employerDetails.company.countryReference && employerDetails.company.countryReference.country_name }}
									</p>
								</div>
