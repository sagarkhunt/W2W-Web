						...
						<div class="row mt-3 m-0">
							<div class="col-12">
								<form class="theme-input">
									...
									<div class="form-row">
										<!--e_invoice_address -->
										<div class="form-group col-8" v-if="isPrivateField.value == false">
											...
											<p class="text-danger">
												{{ eInvoiceAddressField.errorMessage }}
											</p>
										</div>

										<!-- operator code -->
										<div class="form-group col-xl-4 col-lg-6" v-if="isPrivateField.value == false">
										...
										<div class="form-group col-xl-12 col-lg-6">
											...
											<div class="row">
												<div class="col-2 pr-0">
													<input type="text" class="form-control vat-input" readonly :value="countryCode" />
												</div>
												<div class="col-5">
													<input
														id="vat_number"
							...
							<div class="col-12">
								<form class="theme-input">
									...
									<div class="form-row">
										...
										<!-- description -->
										<div class="form-group col-12" v-if="isPrivateField.value == true">
