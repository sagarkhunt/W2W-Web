<template>
	<div class="employerDetails">
		...
		<div class="payment-pill-header">
			...
			<div class="d-flex align-items-start mt-md-0 mt-2">
				<!-- select employer -->
			...
			<div class="pph-left-content">
				<div class="company-content">
					...
					<div class="company-text">
						...
						<p class="company-value">
							{{ employerDetails.company.user.full_name || '-' }}
						</p>
					</div>
...
import { faPlus, faTimes, faChevronUp, faChevronDown } from '@fortawesome/free-solid-svg-icons';
...
export default {
	...
	setup(props) {
		...
		const removeCompany = async id => {
			await store.dispatch('teamInvoice/deleteRemoveCompany', id).then(() => {
				fetchEmplist();
