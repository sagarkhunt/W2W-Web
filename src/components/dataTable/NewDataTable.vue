<template>
	<div class="data__table ">
		<div class="table__header" v-if="search || header">
			...
			<div class="header__right" v-if="search">
				<div class="form-control">
					<input type="text" v-model="searchx" class="border-0 w-100" :placeholder="t('common.search')" />
		...
		<div class="table__data border-table">
			<div class="table-auto">
				...
				<div v-if="isNoData" class="text-center p-4 no_data_table">
					{{ noDataText }}
				</div>
			</div>
		</div>
